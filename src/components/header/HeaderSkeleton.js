			...
			<div className={"header-nav-wrapper"} data-testid={"header-skeleton"}>
				<div className={"header-navbar"}>
					<div className={"header-image"}>
						...
						<Skeleton baseColor={"#eff1f6"} width={80} height={20} style={{ marginLeft: '5px' }} containerClassName={'app-name-skeleton'} />
					</div>
					...
					<ul className={"header-nav"}>
						...
						<li className={"header-nav-item"}>
							...
							<span className={"header-list-name profile-name"}>
								<Skeleton baseColor={"#eff1f6"} width={80} height={20} style={{ marginRight: '5px' }} />
							</span>
						</li>
					</ul>
				</div>
